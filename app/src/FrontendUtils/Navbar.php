...
class Navbar {
                ...
                <ul class="navbar-nav me-auto mb-0">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuAppuntamenti">
                            <li><a class="dropdown-item" href="add_appointment.php">Nuovo appuntamento</a></li>
                            <li><a class="dropdown-item" href="appointment_editor.php">Gestisci appuntamenti</a></li>
                        </ul>
                    </div>
                    <?php break;
                        case APPOINTMENT:?>
                    ...
                    <div class="dropdown">
                        <div class="nav-item nav-link me-2 dropdown-toggle active" role="button" id="dropdownMenuAppuntamenti" data-bs-toggle="dropdown" aria-expanded="false">
                            Appuntamenti
                        </div>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuAppuntamenti">
                            <li><a class="dropdown-item" href="add_appointment.php">Nuovo appuntamento</a></li>
    ...
    <div class="collapse navbar-collapse" id="rightMenu">
        <ul class="mobile-nav me-auto mb-0 mb-lg-0">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link" href="appointment_editor.php">Gestisci appuntamenti</a>
            </li>
            <?php break;
                case APPOINTMENT:
                    if ($isDropDown && $dropDownIndex == 0){?>
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="dashboard.php">Calendario</a>
            </li>
            <li class="nav-item mt-2">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link" href="appointment_editor.php">Gestisci appuntamenti</a>
            <?php } else if ($isDropDown && $dropDownIndex == 1) {?>
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="dashboard.php">Calendario</a>
            </li>
            <li class="nav-item mt-2">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link active" href="appointment_editor.php">Gestisci appuntamenti</a>
            <?php }
                break;
                default: ?>
            <li class="nav-item">
